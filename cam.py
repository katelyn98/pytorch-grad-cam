...
if __name__ == '__main__':
    ...
    mask1_img*=255
    mask_cv1 = cv2.cvtColor(mask1_img, cv2.COLOR_BGR2GRAY)
    masked_bottom1 = cv2.bitwise_and(image, image, mask=mask_cv1)
    ...
    mask2_img*=255
    mask_cv2 = cv2.cvtColor(mask2_img, cv2.COLOR_BGR2GRAY)
    masked_bottom2 = cv2.bitwise_and(image, image, mask=mask_cv2)
    ...
    mask3_img*=255
    mask_cv3 = cv2.cvtColor(mask3_img, cv2.COLOR_BGR2GRAY)
    masked_bottom3 = cv2.bitwise_and(image, image, mask=mask_cv3)
    ...
    mask4_img*=255
    mask_cv4 = cv2.cvtColor(mask4_img, cv2.COLOR_BGR2GRAY)
    masked_bottom4 = cv2.bitwise_and(image, image, mask=mask_cv4)
    ...
    cv2.imwrite(bottom1_filename, masked_bottom1)
    cv2.imwrite(bottom2_filename, masked_bottom2)
